    ...
    public class Email
    {
...

        {
            string htmlBody = "<table><tr><td colspan='4' style='font-family: Raleway; font-size: 12pt;color: darkblue;'>" +
                               ...
                               "<div>" + " <a href='" + applink + @"' style='display: inline-block; margin-top: 20px; padding: 10px 20px; background-color: #007bff; font-size: medium; color: #ffffff; text-decoration: none; border-radius: 10px; padding: 5px;'>Visit Evercare Cafeteria Application</a>" + "</div>" +
                               "</div>" +
                               "</body>";
            return htmlBody;
